...
def analyze_twitter_ads():
    ...
    df = pl.read_csv("datasets/twitter_ads.csv", infer_schema_length=10000)
    ...
    with open("output_polars/twitter_ads_polars_stats.json", "w") as f:
        json.dump({
            "describe": describe,
            "nunique": nunique,
    ...
    print("All done. Results saved to output_polars/twitter_ads_polars_stats.json")
