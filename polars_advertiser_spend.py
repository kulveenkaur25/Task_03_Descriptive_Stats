...
def analyze_advertiser_spend():
    ...
    df = pl.read_csv("datasets/advertiser_spend.csv", infer_schema_length=10000)
    ...
    with open("output_polars/advertiser_spend_polars_stats.json", "w") as f:
        json.dump({
            "describe": describe,
            "nunique": nunique,
    ...
    print("All done. Results saved to output_polars/advertiser_spend_polars_stats.json")
